...
<body>
    ...
    <div class="form_section">
        ...
        <form class="form" action="{{url('signup')}}" method="POST" autocomplete="off" enctype="multipart/form-data">
           @csrf  
            <h1>Register Now</h1>
            <span class="close" onclick="hide()">X</span>
            <input type="email" name="email" placeholder="Email" autofocus required>
            <input type="password" name="pass" placeholder="Password" required>
            <label class="pass_note">Passwords must be at least 8 characters and a combination of letters, numbers, and
                symbols using both upper and lower-case letters.</label>
